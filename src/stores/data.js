    ...
    sub: [
      {
        ...
        plate: {
          ...
          description: [
            ...
            "Developed a Document Management System, allowing users to create credentials and upload PDF files to AWS S3. The system extracts data from the files, developed search engine using Elasticsearch. Admin have capabilities to manage user accounts, including creation and deletion. Leveraged AWS services backend operations, ensuring robust extraction and search functionality. The UI is user-friendly and responsive.",
          ],
          frameWorks: [
            "Reactjs",
            "Nextjs",
